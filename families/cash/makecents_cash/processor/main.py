...
from makecents_cash.processor.handler import IdentityTransactionHandler
from makecents_cash.processor.config.identity import IdentityConfig
from makecents_cash.processor.config.identity import \
...
DISTRIBUTION_NAME = 'makecents-cash'
