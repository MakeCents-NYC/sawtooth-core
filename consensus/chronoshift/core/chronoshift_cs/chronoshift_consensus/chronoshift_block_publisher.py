...
from chronoshift_cs.chronoshift_consensus.consensus_state_store \
    import ConsensusStateStore
#from chronoshift_cs.chronoshift_consensus.chronoshift_settings_view import ChronoShiftStakeView
from chronoshift_cs.chronoshift_consensus.signup_info import SignupInfo
from chronoshift_cs.chronoshift_consensus.chronoshift_key_state_store \
    import ChronoShiftKeyState
from chronoshift_cs.chronoshift_consensus.chronoshift_key_state_store \
    import ChronoShiftKeyStateStore
from chronoshift_cs.chronoshift_consensus.wait_timer import WaitTimer
...
class ChronoShiftBlockPublisher(BlockPublisherInterface):
    ...
    def initialize_block(self, block_header):
        ...
        active_poet_public_key = self._chronoshift_key_state_store.active_key
        ...
        if validator_info.signup_info.poet_public_key != \
            ...
            self._chronoshift_key_state_store.active_key = active_poet_public_key
        ...
        if consensus_state.validator_has_claimed_block_limit(
            ...
            poet_key_state=self._chronoshift_key_state_store[active_poet_public_key]
    ...
    def finalize_block(self, block_header):
        ...
        # sealed_signup_data = poet_key_state.sealed_signup_data
        active_key = self._chronoshift_key_state_store.active_key
        poet_key_state = self._chronoshift_key_state_store[active_key]
        sealed_signup_data = poet_key_state.sealed_signup_data
        try:
            wait_certificate = \
