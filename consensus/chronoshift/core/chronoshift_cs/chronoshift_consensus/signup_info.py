...
class SignupInfo(object):
    ...
    @classmethod
    def signup_info_from_serialized(cls, chronoshift_enclave_module, serialized):
        """
        ...
        """
        enclave_signup_info = \
            chronoshift_enclave_module.deserialize_signup_info(serialized)
    ...
    def unseal_signup_data(cls,
        ...
        """
        return chronoshift_enclave_module.unseal_signup_data(sealed_signup_data)
    ...
    def release_signup_data(cls,
        ...
        Returns:
            ...
            PoET to sign wait certificates.
        """
        return chronoshift_enclave_module.release_signup_data(sealed_signup_data)
