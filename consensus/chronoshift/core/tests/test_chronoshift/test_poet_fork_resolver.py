...
from chronoshift_cs.chronoshift_consensus import chronoshift_fork_resolver
...
#             'PoetSettingsView')
class TestChronoShiftResolver(TestCase):
    ...
    def setUp(self):
        ...
        poet_fork_resolver = reload(chronoshift_fork_resolver)
    ...
    @mock.patch('chronoshift_cs.chronoshift_consensus.chronoshift_fork_resolver.'
                'ConsensusStateStore')
    @mock.patch('chronoshift_cs.chronoshift_consensus.chronoshift_fork_resolver.factory')
    @mock.patch('chronoshift_cs.chronoshift_consensus.chronoshift_fork_resolver.'
                'ConsensusState')
    @mock.patch('chronoshift_cs.chronoshift_consensus.chronoshift_fork_resolver.'
    ...
    def test_new_fork_head_not_poet_block(
        ...
        # check test
        fork_resolver = \
            poet_fork_resolver.ChronoShiftForkResolver(
    ...
    def test_cur_fork_head_not_poet_block(
        ...
        # check test
        with mock.patch('chronoshift_cs.chronoshift_consensus.chronoshift_fork_resolver.'
