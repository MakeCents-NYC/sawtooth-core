...
from chronoshift_simulator.chronoshift_enclave_simulator \
    import chronoshift_enclave_simulator as chronoshift_enclave
...
class TestSignupInfo(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        chronoshift_enclave.initialize(cls._temp_dir, cls._temp_dir)
    ...
    def test_create(self):
        signup_info = \
            SignupInfo.create_signup_info(
                chronoshift_enclave_module=chronoshift_enclave,
        ...
        self.assertIsNotNone(signup_info.stake_address)
