...
from chronoshift_cli.main import main
...
class TestValidatorRegistryGenesisTransaction(unittest.TestCase):
    ...
    @patch('chronoshift_cli.registration.ChronoShiftKeyStateStore')
    @patch('chronoshift_cli.registration.config.get_data_dir')
    @patch('chronoshift_cli.registration.config.get_key_dir')
    ...
    def _assert_validator_transaction(self, public_key, target_file):
        ...
        payload = cr_pb.ChronoShiftRegistryPayload()
