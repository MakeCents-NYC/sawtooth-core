...
class ChronoShiftEnclaveModuleWrapper(object):
    ...
    def __init__(self, enclave_module, config_dir, data_dir):
        ...
        try:
            self._chronoshift_enclave_module = importlib.import_module(module_name)
        except ImportError as e:
            raise AssertionError(str(e))

        self._chronoshift_enclave_module.initialize(config_dir, data_dir)

    def __enter__(self):
        return self._chronoshift_enclave_module

    def __exit__(self, exc_type, exc_val, exc_tb):
        self._chronoshift_enclave_module.shutdown()
