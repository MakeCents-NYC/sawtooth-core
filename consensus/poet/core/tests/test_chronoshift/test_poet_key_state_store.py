...
from chronoshift_cs.chronoshift_consensus import chronoshift_key_state_store
...
class TestPoetKeyStateStore(unittest.TestCase):
    def setUp(self):
        ...
        poet_key_state_store = reload(chronoshift_key_state_store)

    @patch('chronoshift_cs.chronoshift_consensus.chronoshift_key_state_store.'
           'LMDBNoLockDatabase')
    def test_store_verify_db_creation(self, mock_lmdb):
        ...
        """
        _ = \
            poet_key_state_store.ChronoShiftKeyStateStore(
    ...
    def test_active_key_present(self, mock_lmdb):
        ...
        mock_lmdb.return_value = {
            'ppk_1':
                poet_key_state_store.ChronoShiftKeyState(
