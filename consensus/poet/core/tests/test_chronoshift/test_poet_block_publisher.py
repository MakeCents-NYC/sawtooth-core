...
from chronoshift_cs.chronoshift_consensus import chronoshift_block_publisher
from chronoshift_cs.chronoshift_consensus.mock_consensus_state import\
    MockConsensusState
...
class TestChronoShiftBlockPublisher(TestCase):
    ...
    def setUp(self):
        ...
        # ChronoShiftBlockPublisher uses class variables to hold state
        # so the module needs to be reloaded after each test to clear state
        poet_block_publisher = reload(chronoshift_block_publisher)
    ...
    @mock.patch('chronoshift_cs.chronoshift_consensus.chronoshift_block_publisher.'
                'ConsensusStateStore')
    @mock.patch('chronoshift_cs.chronoshift_consensus.chronoshift_block_publisher.factory')
    @mock.patch('chronoshift_cs.chronoshift_consensus.chronoshift_block_publisher.'
                'ConsensusState')
    @mock.patch('chronoshift_cs.chronoshift_consensus.chronoshift_block_publisher.'
    ...
    def test_no_validator_registry(
        ...
        # check test
        block_publisher = \
            poet_block_publisher.ChronoShiftBlockPublisher(
    ...
    def test_signup_info_not_committed_within_allowed_delay(
        ...
        # check test
        with mock.patch('chronoshift_cs.chronoshift_consensus.chronoshift_block_publisher.'
    ...
    @mock.patch('chronoshift_cs.chronoshift_consensus.chronoshift_block_publisher.WaitTimer')
    @mock.patch('chronoshift_cs.chronoshift_consensus.chronoshift_block_publisher.'
                'SignupInfo')
    @mock.patch('chronoshift_cs.chronoshift_consensus.chronoshift_block_publisher.'
                'ChronoShiftKeyStateStore')
