...
from chronoshift_cs.chronoshift_consensus.chronoshift_block_verifier import ChronoShiftBlockVerifier
...
class TestPoetBlockVerifier(TestCase):
    ...
    def test_non_poet_block(self,
        ...
        with mock.patch('chronoshift_cs.chronoshift_consensus.chronoshift_block_verifier.'
                        'LOGGER') as mock_logger:
            block_verifier = \
                ChronoShiftBlockVerifier(
