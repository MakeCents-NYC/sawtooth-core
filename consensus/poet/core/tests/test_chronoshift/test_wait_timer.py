...
import chronoshift_simulator.chronoshift_enclave_simulator.chronoshift_enclave_simulator as chronoshift_enclave

from chronoshift_cs.chronoshift_consensus.consensus_state import ConsensusState

import chronoshift_cs.chronoshift_consensus.wait_timer as wait_timer
...
class TestWaitTimer(TestCase):
    ...
    def test_create(self):
        ...
        wt = wait_timer.WaitTimer.create_wait_timer(
            chronoshift_enclave_module=mock_poet_enclave_simulator,
        ...
        self.poet_enclave_module = reload(chronoshift_enclave)
