...
class ChronoShiftKeyStateStore(MutableMapping):
    ...
    def __init__(self, data_dir, validator_id):
        ...
        Returns:
            None
        """
        with ChronoShiftKeyStateStore._lock:
            ...
            self._store_db = ChronoShiftKeyStateStore._store_dbs.get(validator_id)
            if self._store_db is None:
                ...
                self._store_db = \
                    LMDBNoLockDatabase(
                        ...
                        flag='c')
                ChronoShiftKeyStateStore._store_dbs[validator_id] = self._store_db
    ...
    def __setitem__(self, poet_public_key, poet_key_state):
        ...
        """
        ChronoShiftKeyStateStore._check_poet_key_state(poet_key_state)
    ...
    def __getitem__(self, poet_public_key):
        ...
        try:
            poet_key_state = \
                ChronoShiftKeyState._make(self._store_db[poet_public_key])
            ...
            try:
                ...
                poet_key_state = ChronoShiftKeyState._make(old_key_state)
