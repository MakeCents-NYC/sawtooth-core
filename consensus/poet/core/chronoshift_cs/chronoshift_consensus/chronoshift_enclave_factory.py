...
class ChronoShiftEnclaveFactory(object):
    """PoetEnclaveFactory provides a mechanism for abstracting the loading of
    a PoET enclave module.
    """

    _lock = threading.Lock()
    _chronoshift_enclave_module = None

    @classmethod
    def get_chronoshift_enclave_module(cls, state_view, config_dir, data_dir):
        ...
        with cls._lock:
            ...
            if cls._chronoshift_enclave_module is None:
                ...
                cls._chronoshift_enclave_module = module

        return cls._chronoshift_enclave_module
