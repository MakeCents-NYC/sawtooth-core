...
class WaitCertificate(object):
    ...
    def create_wait_certificate(cls,
        ...
        try:
            enclave_certificate = \
                    chronoshift_enclave_module.create_wait_certificate(
                    sealed_signup_data,
    ...
    def wait_certificate_from_serialized(cls,
        ...
        """
        enclave_certificate = \
            chronoshift_enclave_module.deserialize_wait_certificate(
                serialized,
                signature)
    ...
    def _enclave_wait_certificate(self, chronoshift_enclave_module):
        return \
            chronoshift_enclave_module.deserialize_wait_certificate(
    ...
    def check_valid(self,
        ...
        try:
            chronoshift_enclave_module.verify_wait_certificate(
                enclave_certificate,
                poet_public_key)
        except Timeout:
